...
function MercadoPage() {
  return (
    <Container>
        ...
        <ContainerGeral>
          {categorias.map((categoria) => (
            <ContainerFilho key={categoria.id}>
              <Categoria>{categoria.titule}</Categoria>
              <ul>
      ...
      <ContainerRight>
        <AdicionarAnuncio>
          <ButtonAdicionar>Para adicionar um anúncio</ButtonAdicionar>
        </AdicionarAnuncio>
        <ContainerAnuncioGratis>
          <Titulo>Anúncios grátis</Titulo>
          ...
          <Paragrafo>
            Compre peças e peças necessárias de pessoas boas, venda as suas.
            Você pode postar seu anúncio gratuitamente. Não se esqueça de ler as
...
const categorias = [
  {
    ...
    subcatego: [" agua ", " rosada ", " acustica ", "cameras"],
  },
