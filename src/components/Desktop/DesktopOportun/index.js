...
function DesktopOportun() {
  return (
    <Container>
      ...
      <OportunidadeDoDia>Oportunidade do dia</OportunidadeDoDia>

      <Marca>Mercedes-Bez A 169 AMG Line</Marca>
      <Caracteristicas>
        <li>2020</li>.<li>3549</li>
        <li>km</li>.<li>Gasolina</li>.<li>Janeiro</li>.<li>109</li>
        <li>cv</li>
      </Caracteristicas>
      <ValorDoCarro>
        28 990
